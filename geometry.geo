...
//+
Point(164) = {x0, inlet_h - h, 0, 1.0};
//+
Point(165) = {x1, inlet_h - h, 0, 1.0};
//+
Point(166) = {x0,  -h, 0, 1.0};
//+
Point(167) = {x1,  -h, 0, 1.0};

//+
Split Curve {1} Point {70, 90, 1};
//+
Point(168) = {-inlet_dist, y_inlet, 0, 1.0};
//+
Point(169) = {-inlet_dist, -y_inlet, 0, 1.0};
//+
Point(170) = {length - inlet_dist, 0.064, 0, 1.0};
//+
Line(5) = {70, 164};
//+
Line(6) = {70, 168};
...
Plane Surface(2) = {2};
//+
Curve Loop(3) = {17, 19, -13, -8};
//+
Plane Surface(3) = {3};
//+
Curve Loop(4) = {16, -20, -17, 9};
//+
Plane Surface(4) = {4};
//+
Curve Loop(5) = {15, -9, -3, 10};
//+
Plane Surface(5) = {5};
//+
Curve Loop(6) = {-14, -10, 7, 22};
//+
Plane Surface(6) = {6};
//+
Curve Loop(7) = {7, 23, -6, 2};
//+
Plane Surface(7) = {7};
//+
//Inlet and leading edge
Transfinite Curve {2, 23} = 16 Using Progression 1;
//+
//Top and bottom airfoil
Transfinite Curve {4, 12, 3, 15} = 52 Using Progression 1;
//+
//Vertical
Transfinite Curve {5, 8, 10, 9, 21, 22} = nVert Using Progression 1.09;
//+
//Horizontal leading edge
Transfinite Curve {11, 6, 7, 14} = 68 Using Progression 1.016;
//+
//Horizontal wake
Transfinite Curve {13, 17, 16} = 120 Using Progression 1.02;
//+
//Outlet
Transfinite Curve {20, 19} = nVert Using Progression 1;
//+
...
//+
Recombine Surface {6, 7, 1, 2, 3, 4, 5};
